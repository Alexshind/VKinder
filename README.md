...
- После первого запуска появиться новый файл в активной директории с названием "token_bd.ini"
- Введите ваши токены и данные для подключения к вашей базе данных
